...
const roomDetails: Array<{ kind: string; isAvailable?: boolean; note?: string }> = [
  ...
  { kind: "Assessoria APM" },
  { kind: "Secretaria" },
  { kind: "Sala", isAvailable: false, note: "Sem uso para reservas e horários." },
  ...
  { kind: "Laboratório (Química)" },
  { kind: "Sala de aula", isAvailable: false, note: "Sala interditada." },
  { kind: "Sala", isAvailable: false, note: "Sem uso para reservas e horários." },
  ...
  { kind: "Laboratório de informática" },
  { kind: "Laboratório de informática" },
  { kind: "Laboratório de informática" },
  { kind: "Laboratório de informática" },
  { kind: "Laboratório de informática" },
