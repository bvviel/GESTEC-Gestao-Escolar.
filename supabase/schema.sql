...
values
  ...
  ('Sala 09', '2º andar', 'Sala'),
  ('Sala 10', '2º andar', 'Sala'),
  ('Sala 11', '2º andar', 'Sala'),
  ('Sala 12', '2º andar', 'Sala'),
  ('Sala 13', '2º andar', 'Sala'),
  ('Sala 14', '2º andar', 'Sala'),
  ('Sala 15', '2º andar', 'Sala'),
  ('Sala 16', '2º andar', 'Sala'),
  ('Sala 17', '2º andar', 'Sala'),
  ('Sala 18', '3º andar', 'Sala'),
  ('Sala 19', '3º andar', 'Sala'),
  ('Sala 20', '3º andar', 'Sala'),
  ('Sala 21', '3º andar', 'Sala'),
  ('Sala 22', '3º andar', 'Sala'),
  ('Sala 23', '3º andar', 'Sala'),
  ('Sala 24', '3º andar', 'Sala'),
  ('Sala 25', '3º andar', 'Sala'),
  ('Sala 26', '3º andar', 'Sala'),
  ('Sala 27', '3º andar', 'Sala'),
  ('Sala 28', '4º andar', 'Sala'),
  ('Sala 29', '4º andar', 'Sala'),
  ('Sala 30', '4º andar', 'Sala'),
  ('Sala 31', '4º andar', 'Sala'),
  ('Sala 32', '4º andar', 'Sala'),
  ('Sala 33', '4º andar', 'Sala'),
  ('Sala 34', '4º andar', 'Sala'),
  ('Sala 35', '4º andar', 'Sala'),
  ('Sala 36', '4º andar', 'Sala'),
  ('Sala 37', '4º andar', 'Sala'),
  ('Sala 38', 'Bloco B', 'Sala'),
  ('Sala 39', 'Bloco B', 'Sala'),
  ('Sala 40', 'Bloco B', 'Sala'),
  ('Sala 41', 'Bloco B', 'Sala'),
  ('Sala 42', 'Bloco B', 'Sala'),
  ('Sala 43', 'Bloco B', 'Sala')
