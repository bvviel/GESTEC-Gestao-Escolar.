...
create index if not exists rooms_is_available_idx on public.rooms (is_available, name);
...
with room_details(name, kind, is_available, availability_note) as (
  values
    ...
    ('Sala 05', 'Sala', false, 'Sem uso para reservas e horários.'),
    ...
    ('Sala 10', 'Sala', false, 'Sem uso para reservas e horários.'),
    ('Sala 11', 'Sala Maker', true, null),
    ('Sala 12', 'Laboratório (Química)', true, null),
    ('Sala 13', 'Laboratório (Química)', true, null),
    ('Sala 14', 'Sala de aula', false, 'Sala interditada.'),
    ('Sala 15', 'Sala', false, 'Sem uso para reservas e horários.'),
    ('Sala 16', 'Armazém de comida', true, null),
    ('Sala 17', 'Sala', false, 'Sem uso para reservas e horários.'),
    ('Sala 18', 'Sala', false, 'Sem uso para reservas e horários.'),
    ('Sala 19', 'Sala', false, 'Sem uso para reservas e horários.'),
    ('Sala 20', 'Almoxarifado', true, null),
    ('Sala 21', 'Sala TI', true, null),
    ('Sala 22', 'Sala Prof. Valdson', true, null),
    ('Sala 23', 'Laboratório de informática', true, null),
    ('Sala 24', 'Laboratório de informática', true, null),
    ('Sala 25', 'Laboratório de informática', true, null),
    ('Sala 26', 'Laboratório de informática', true, null),
    ('Sala 27', 'Laboratório de informática', true, null),
    ('Sala 28', 'Laboratório de informática', true, null),
    ('Sala 29', 'Sala', false, 'Sem uso para reservas e horários.'),
    ...
    ('Sala 38', 'Sala', false, 'Sem uso para reservas e horários.'),
    ('Sala 39', 'Sala', false, 'Sem uso para reservas e horários.'),
